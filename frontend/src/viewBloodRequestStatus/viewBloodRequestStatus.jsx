...
import { getRequests, getBloodTypes, getBloodBankById } from '../api';
...
function ViewBloodRequestStatus() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const bloodTypeData = bloodTypesResponse.data.reduce((acc, bloodType) => {
    ...
    const handleContactBank = async (bloodBankId) => {
        try {
            const response = await getBloodBankById(bloodBankId);
            const bank = response.data;
            navigate(`/viewBanks/viewBankDetails/${bloodBankId}`, { state: { bank } });
        } catch (error) {
            ...
            <div className='view-blood-request-status-container-view'>
                ...
                <div className='blood-request-status-list'>
                    {bloodRequests.map((bloodRequest) => (
                        <div key={bloodRequest.requestID} className='blood-request-status-block'>
                            ...
                            <div className='blood-request-status-body'>
                                <div className='blood-request-status-item'>
                                    ...
                                    <p>
                                        ...
                                        <span className="value">{bloodRequest.requestID}</span>
                                    </p>
                                </div>
                                <div className='blood-request-status-item'>
                                    ...
                                    <p>
                                        ...
                                        <span className="value">{bloodTypes[bloodRequest.bloodTypeId] || 'Cargando...'}</span>
                                    </p>
                                </div>
                                <div className='blood-request-status-item'>
                                    ...
                                    <p>
                                        ...
                                        <span className="value">{bloodRequest.requestedAmount} pintas</span>
                                    </p>
                                </div>
                                <div className='blood-request-status-item'>
                                    ...
                                    <p>
                                        ...
                                        <span className="value">{bloodRequest.status === 1 ? 'Pendiente' : 'Completada'}</span>
                                    </p>
                                </div>
                                <div className='blood-request-status-item'>
                                    ...
                                    <p>
                                        ...
                                        <span className="value">{new Date(bloodRequest.requestTimeStamp).toLocaleDateString()}</span>
                                    </p>
                                </div>
                                <div className='blood-request-status-item'>
                                    ...
                                    <p>
                                        ...
                                        <span className="value">{new Date(bloodRequest.requestTimeStamp).toLocaleTimeString()}</span>
                                    </p>
                                </div>
                                <button 
